...
I am an Applied Economics student interested in empirical finance, supply chain finance, credit risk, business analytics, and data-driven analysis of real economic and business problems. I use Python, Stata, and R to build reproducible empirical projects, clean financial and firm-level data, and study how financial tools, data, and institutional arrangements can better support firms, banks, and real-economy decision-making.

## Research Interests

- Supply chain finance and real-economy financing
- Credit risk, banking data, and risk management
- Empirical finance and applied econometrics
- Financial technology and data-driven business decisions
- SME financing constraints and supply chain resilience
- Business analytics and AI-era information problems

## Tools & Methods

I have used these tools and methods in coursework, research projects, internships, and independent project repositories. I treat them as a working toolkit for asking better empirical questions, not as a checklist of claims to expertise.
...
- Credit risk modeling and ridge regression
- Bootstrap analysis and PLS-SEM
...
I care less about using models for their own sake and more about connecting models with real economic questions. I am especially interested in how finance, data, and institutional design can help firms access funding, help banks understand risk, and help supply chains become more resilient. I also pay attention to how AI and data technologies affect business decision-making, while staying focused on the economic meaning behind the tools.

## Current Focus

- Strengthening empirical research skills
- Building reproducible Python/Stata/R project repositories
- Studying supply chain finance, credit risk, and applied econometrics
- Exploring how data and AI can support real business and financial decisions
